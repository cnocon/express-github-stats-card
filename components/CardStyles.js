module.exports = {
  styles: `<style>
      ...
      #github-stats-card {max-width: 320px; margin: auto; width: 100%; padding: 0; background-color: #fff; box-sizing: border-box; font-family: Arial, sans-serif;  display: flex; border: 1px solid #e9e9e9; flex-direction: column; flex-basis: 100%; font-size: 12px; line-height: 16px; box-shadow: 5px 10px 20px -10px rgba(0,0,0,.2);}
